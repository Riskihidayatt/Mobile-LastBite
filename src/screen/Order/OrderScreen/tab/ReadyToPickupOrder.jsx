        ...
        <View className={`rounded-2xl p-4 mb-4 shadow-md shadow-black/5 mx-4 ${isDark ? 'bg-gray-800' : 'bg-white'}`}>
            ...
            <View className="flex-row items-center mb-3">
                ...
                <View>
                    ...
                    <Text className={`text-xs font-semibold uppercase ${isDark ? 'text-purple-400' : 'text-purple-600'}`}>
...
const ReadyToPickupOrder = () => {
    ...
    useFocusEffect(
        useCallback(() => {
            dispatch(fetchCustomerOrders('READY_FOR_PICKUP'));
        }, [dispatch])
    );
